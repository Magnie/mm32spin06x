...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<Comp1CsrSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Comparator 1 mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<Comp1CsrSpec> {
        ModeW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Comparator 1 inverting input selection"]
    #[inline(always)]
    #[must_use]
    pub fn inm_sel(&mut self) -> InmSelW<Comp1CsrSpec> {
        InmSelW::new(self, 4)
    }
    #[doc = "Bits 7:8 - Comparator 1 normal phase input selection"]
    #[inline(always)]
    #[must_use]
    pub fn inp_sel(&mut self) -> InpSelW<Comp1CsrSpec> {
        InpSelW::new(self, 7)
    }
    #[doc = "Bits 10:13 - Comparator 1 output selection"]
    #[inline(always)]
    #[must_use]
    pub fn out_sel(&mut self) -> OutSelW<Comp1CsrSpec> {
        OutSelW::new(self, 10)
    }
    #[doc = "Bit 15 - Comparator 1 output polarity"]
    #[inline(always)]
    #[must_use]
    pub fn pol(&mut self) -> PolW<Comp1CsrSpec> {
        PolW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Comparator 1 hysteresis"]
    #[inline(always)]
    #[must_use]
    pub fn hyst(&mut self) -> HystW<Comp1CsrSpec> {
        HystW::new(self, 16)
    }
    #[doc = "Bits 18:20 - Comparator output filter"]
    #[inline(always)]
    #[must_use]
    pub fn oflt(&mut self) -> OfltW<Comp1CsrSpec> {
        OfltW::new(self, 18)
    }
    #[doc = "Bit 30 - Comparator 1 lock"]
    #[inline(always)]
    #[must_use]
    pub fn out(&mut self) -> OutW<Comp1CsrSpec> {
        OutW::new(self, 30)
    }
    #[doc = "Bit 31 - Comparator lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<Comp1CsrSpec> {
        LockW::new(self, 31)
    }
}
