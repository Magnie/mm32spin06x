...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<Comp2CsrSpec> {
        ModeW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Comparator 2 inverting input selection"]
    #[inline(always)]
    #[must_use]
    pub fn inm_sel(&mut self) -> InmSelW<Comp2CsrSpec> {
        InmSelW::new(self, 4)
    }
    #[doc = "Bits 7:8 - Comparator 2 normal phase input selection"]
    #[inline(always)]
    #[must_use]
    pub fn inp_sel(&mut self) -> InpSelW<Comp2CsrSpec> {
        InpSelW::new(self, 7)
    }
    #[doc = "Bits 10:13 - Comparator 2 output selection"]
    #[inline(always)]
    #[must_use]
    pub fn out_sel(&mut self) -> OutSelW<Comp2CsrSpec> {
        OutSelW::new(self, 10)
    }
    #[doc = "Bit 15 - Comparator 2 output polarity"]
    #[inline(always)]
    #[must_use]
    pub fn pol(&mut self) -> PolW<Comp2CsrSpec> {
        PolW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Comparator 2 hysteresis"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn oflt(&mut self) -> OfltW<Comp2CsrSpec> {
        OfltW::new(self, 18)
    }
    #[doc = "Bit 30 - Comparator 2 lock"]
    #[inline(always)]
    #[must_use]
    pub fn out(&mut self) -> OutW<Comp2CsrSpec> {
        OutW::new(self, 30)
    }
    #[doc = "Bit 31 - Comparator lock"]
    #[inline(always)]
