...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn poll_en(&mut self) -> PollEnW<Comp1PollSpec> {
        PollEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Comparator 1 polling pollingchannel"]
    #[inline(always)]
    #[must_use]
    pub fn poll_ch(&mut self) -> PollChW<Comp1PollSpec> {
        PollChW::new(self, 1)
    }
    #[doc = "Bit 2 - Comparator 1 Polling inverting input fix"]
    #[inline(always)]
    #[must_use]
    pub fn fixn(&mut self) -> FixnW<Comp1PollSpec> {
        FixnW::new(self, 2)
    }
    #[doc = "Bits 4:6 - Comparator 1 polling wait cycle"]
    #[inline(always)]
    #[must_use]
    pub fn period(&mut self) -> PeriodW<Comp1PollSpec> {
        PeriodW::new(self, 4)
    }
    #[doc = "Bits 8:10 - Comparator 1 Polling output"]
    #[inline(always)]
    #[must_use]
    pub fn pout(&mut self) -> PoutW<Comp1PollSpec> {
        PoutW::new(self, 8)
    }
}
