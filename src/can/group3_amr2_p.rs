...
pub type R = crate::R<Group3Amr2PSpec>;
#[doc = "Register `GROUP3_AMR2_P` writer"]
pub type W = crate::W<Group3Amr2PSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn am(&mut self) -> AmW<Group3Amr2PSpec> {
        AmW::new(self, 0)
    }
}
...
pub struct Group3Amr2PSpec;
impl crate::RegisterSpec for Group3Amr2PSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`group3_amr2_p::R`](R) reader structure"]
impl crate::Readable for Group3Amr2PSpec {}
#[doc = "`write(|w| ..)` method takes [`group3_amr2_p::W`](W) writer structure"]
impl crate::Writable for Group3Amr2PSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GROUP3_AMR2_P to value 0"]
impl crate::Resettable for Group3Amr2PSpec {
