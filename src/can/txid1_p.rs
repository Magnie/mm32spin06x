...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn id13(&mut self) -> Id13W<Txid1PSpec> {
        Id13W::new(self, 0)
    }
    #[doc = "Bit 1 - Identifier bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn id14(&mut self) -> Id14W<Txid1PSpec> {
        Id14W::new(self, 1)
    }
    #[doc = "Bit 2 - Identifier bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn id15(&mut self) -> Id15W<Txid1PSpec> {
        Id15W::new(self, 2)
    }
    #[doc = "Bit 3 - Identifier bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn id16(&mut self) -> Id16W<Txid1PSpec> {
        Id16W::new(self, 3)
    }
    #[doc = "Bit 4 - Identifier bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn id17(&mut self) -> Id17W<Txid1PSpec> {
        Id17W::new(self, 4)
    }
    #[doc = "Bit 5 - Identifier bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn id18(&mut self) -> Id18W<Txid1PSpec> {
        Id18W::new(self, 5)
    }
    #[doc = "Bit 6 - Identifier bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn id19(&mut self) -> Id19W<Txid1PSpec> {
        Id19W::new(self, 6)
    }
    #[doc = "Bit 7 - Identifier bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn id20(&mut self) -> Id20W<Txid1PSpec> {
        Id20W::new(self, 7)
    }
}
