...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dlc(&mut self) -> DlcW<Txid1BSpec> {
        DlcW::new(self, 0)
    }
    #[doc = "Bit 4 - Remote transmission request"]
    #[inline(always)]
    #[must_use]
    pub fn rtr(&mut self) -> RtrW<Txid1BSpec> {
        RtrW::new(self, 4)
    }
    #[doc = "Bit 5 - Identifier bit 0"]
    #[inline(always)]
    #[must_use]
    pub fn id0(&mut self) -> Id0W<Txid1BSpec> {
        Id0W::new(self, 5)
    }
    #[doc = "Bit 6 - Identifier bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn id1(&mut self) -> Id1W<Txid1BSpec> {
        Id1W::new(self, 6)
    }
    #[doc = "Bit 7 - Identifier bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn id2(&mut self) -> Id2W<Txid1BSpec> {
        Id2W::new(self, 7)
    }
}
