...
pub type R = crate::R<Group1Acr2PSpec>;
#[doc = "Register `GROUP1_ACR2_P` writer"]
pub type W = crate::W<Group1Acr2PSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ac(&mut self) -> AcW<Group1Acr2PSpec> {
        AcW::new(self, 0)
    }
}
...
pub struct Group1Acr2PSpec;
impl crate::RegisterSpec for Group1Acr2PSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`group1_acr2_p::R`](R) reader structure"]
impl crate::Readable for Group1Acr2PSpec {}
#[doc = "`write(|w| ..)` method takes [`group1_acr2_p::W`](W) writer structure"]
impl crate::Writable for Group1Acr2PSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GROUP1_ACR2_P to value 0"]
impl crate::Resettable for Group1Acr2PSpec {
