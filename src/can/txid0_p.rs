...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn id21(&mut self) -> Id21W<Txid0PSpec> {
        Id21W::new(self, 0)
    }
    #[doc = "Bit 1 - Identifier bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn id22(&mut self) -> Id22W<Txid0PSpec> {
        Id22W::new(self, 1)
    }
    #[doc = "Bit 2 - Identifier bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn id23(&mut self) -> Id23W<Txid0PSpec> {
        Id23W::new(self, 2)
    }
    #[doc = "Bit 3 - Identifier bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn id24(&mut self) -> Id24W<Txid0PSpec> {
        Id24W::new(self, 3)
    }
    #[doc = "Bit 4 - Identifier bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn id25(&mut self) -> Id25W<Txid0PSpec> {
        Id25W::new(self, 4)
    }
    #[doc = "Bit 5 - Identifier bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn id26(&mut self) -> Id26W<Txid0PSpec> {
        Id26W::new(self, 5)
    }
    #[doc = "Bit 6 - Identifier bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn id27(&mut self) -> Id27W<Txid0PSpec> {
        Id27W::new(self, 6)
    }
    #[doc = "Bit 7 - Identifier bit 28"]
    #[inline(always)]
    #[must_use]
    pub fn id28(&mut self) -> Id28W<Txid0PSpec> {
        Id28W::new(self, 7)
    }
}
