...
pub type R = crate::R<Group9Amr3PSpec>;
#[doc = "Register `GROUP9_AMR3_P` writer"]
pub type W = crate::W<Group9Amr3PSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn am(&mut self) -> AmW<Group9Amr3PSpec> {
        AmW::new(self, 0)
    }
}
...
pub struct Group9Amr3PSpec;
impl crate::RegisterSpec for Group9Amr3PSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`group9_amr3_p::R`](R) reader structure"]
impl crate::Readable for Group9Amr3PSpec {}
#[doc = "`write(|w| ..)` method takes [`group9_amr3_p::W`](W) writer structure"]
impl crate::Writable for Group9Amr3PSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GROUP9_AMR3_P to value 0"]
impl crate::Resettable for Group9Amr3PSpec {
