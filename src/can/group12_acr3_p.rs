...
pub type R = crate::R<Group12Acr3PSpec>;
#[doc = "Register `GROUP12_ACR3_P` writer"]
pub type W = crate::W<Group12Acr3PSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ac(&mut self) -> AcW<Group12Acr3PSpec> {
        AcW::new(self, 0)
    }
}
...
pub struct Group12Acr3PSpec;
impl crate::RegisterSpec for Group12Acr3PSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`group12_acr3_p::R`](R) reader structure"]
impl crate::Readable for Group12Acr3PSpec {}
#[doc = "`write(|w| ..)` method takes [`group12_acr3_p::W`](W) writer structure"]
impl crate::Writable for Group12Acr3PSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GROUP12_ACR3_P to value 0"]
impl crate::Resettable for Group12Acr3PSpec {
