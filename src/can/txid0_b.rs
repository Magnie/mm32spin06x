...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn id3(&mut self) -> Id3W<Txid0BSpec> {
        Id3W::new(self, 0)
    }
    #[doc = "Bit 1 - Identifier bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn id4(&mut self) -> Id4W<Txid0BSpec> {
        Id4W::new(self, 1)
    }
    #[doc = "Bit 2 - Identifier bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn id5(&mut self) -> Id5W<Txid0BSpec> {
        Id5W::new(self, 2)
    }
    #[doc = "Bit 3 - Identifier bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn id6(&mut self) -> Id6W<Txid0BSpec> {
        Id6W::new(self, 3)
    }
    #[doc = "Bit 4 - Identifier bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn id7(&mut self) -> Id7W<Txid0BSpec> {
        Id7W::new(self, 4)
    }
    #[doc = "Bit 5 - Identifier bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn id8(&mut self) -> Id8W<Txid0BSpec> {
        Id8W::new(self, 5)
    }
    #[doc = "Bit 6 - Identifier bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn id9(&mut self) -> Id9W<Txid0BSpec> {
        Id9W::new(self, 6)
    }
    #[doc = "Bit 7 - Identifier bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn id10(&mut self) -> Id10W<Txid0BSpec> {
        Id10W::new(self, 7)
    }
}
