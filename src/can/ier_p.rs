...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rie(&mut self) -> RieW<IerPSpec> {
        RieW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn tie(&mut self) -> TieW<IerPSpec> {
        TieW::new(self, 1)
    }
    #[doc = "Bit 2 - Error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn eie(&mut self) -> EieW<IerPSpec> {
        EieW::new(self, 2)
    }
    #[doc = "Bit 3 - Data overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn doie(&mut self) -> DoieW<IerPSpec> {
        DoieW::new(self, 3)
    }
    #[doc = "Bit 5 - Error passive interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn epie(&mut self) -> EpieW<IerPSpec> {
        EpieW::new(self, 5)
    }
    #[doc = "Bit 6 - Arbitration lost interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn alie(&mut self) -> AlieW<IerPSpec> {
        AlieW::new(self, 6)
    }
    #[doc = "Bit 7 - Bus error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn beie(&mut self) -> BeieW<IerPSpec> {
        BeieW::new(self, 7)
    }
}
