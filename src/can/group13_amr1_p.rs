...
pub type R = crate::R<Group13Amr1PSpec>;
#[doc = "Register `GROUP13_AMR1_P` writer"]
pub type W = crate::W<Group13Amr1PSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn am(&mut self) -> AmW<Group13Amr1PSpec> {
        AmW::new(self, 0)
    }
}
...
pub struct Group13Amr1PSpec;
impl crate::RegisterSpec for Group13Amr1PSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`group13_amr1_p::R`](R) reader structure"]
impl crate::Readable for Group13Amr1PSpec {}
#[doc = "`write(|w| ..)` method takes [`group13_amr1_p::W`](W) writer structure"]
impl crate::Writable for Group13Amr1PSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GROUP13_AMR1_P to value 0"]
impl crate::Resettable for Group13Amr1PSpec {
