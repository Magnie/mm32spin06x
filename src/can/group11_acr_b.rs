...
pub type R = crate::R<Group11AcrBSpec>;
#[doc = "Register `GROUP11_ACR_B` writer"]
pub type W = crate::W<Group11AcrBSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ac(&mut self) -> AcW<Group11AcrBSpec> {
        AcW::new(self, 0)
    }
}
...
pub struct Group11AcrBSpec;
impl crate::RegisterSpec for Group11AcrBSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`group11_acr_b::R`](R) reader structure"]
impl crate::Readable for Group11AcrBSpec {}
#[doc = "`write(|w| ..)` method takes [`group11_acr_b::W`](W) writer structure"]
impl crate::Writable for Group11AcrBSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GROUP11_ACR_B to value 0"]
impl crate::Resettable for Group11AcrBSpec {
