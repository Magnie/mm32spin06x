...
pub type R = crate::R<Group16Acr1PSpec>;
#[doc = "Register `GROUP16_ACR1_P` writer"]
pub type W = crate::W<Group16Acr1PSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ac(&mut self) -> AcW<Group16Acr1PSpec> {
        AcW::new(self, 0)
    }
}
...
pub struct Group16Acr1PSpec;
impl crate::RegisterSpec for Group16Acr1PSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`group16_acr1_p::R`](R) reader structure"]
impl crate::Readable for Group16Acr1PSpec {}
#[doc = "`write(|w| ..)` method takes [`group16_acr1_p::W`](W) writer structure"]
impl crate::Writable for Group16Acr1PSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GROUP16_ACR1_P to value 0"]
impl crate::Resettable for Group16Acr1PSpec {
