...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rbs(&mut self) -> RbsW<SrSpec> {
        RbsW::new(self, 0)
    }
    #[doc = "Bit 1 - Data overrun status"]
    #[inline(always)]
    #[must_use]
    pub fn dos(&mut self) -> DosW<SrSpec> {
        DosW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit buffer status"]
    #[inline(always)]
    #[must_use]
    pub fn tbs(&mut self) -> TbsW<SrSpec> {
        TbsW::new(self, 2)
    }
    #[doc = "Bit 3 - Transmission complete status"]
    #[inline(always)]
    #[must_use]
    pub fn tcs(&mut self) -> TcsW<SrSpec> {
        TcsW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive status"]
    #[inline(always)]
    #[must_use]
    pub fn rs(&mut self) -> RsW<SrSpec> {
        RsW::new(self, 4)
    }
    #[doc = "Bit 5 - Transmit status"]
    #[inline(always)]
    #[must_use]
    pub fn ts(&mut self) -> TsW<SrSpec> {
        TsW::new(self, 5)
    }
    #[doc = "Bit 6 - Error status"]
    #[inline(always)]
    #[must_use]
    pub fn es(&mut self) -> EsW<SrSpec> {
        EsW::new(self, 6)
    }
    #[doc = "Bit 7 - Bus status"]
    #[inline(always)]
    #[must_use]
    pub fn bs(&mut self) -> BsW<SrSpec> {
        BsW::new(self, 7)
    }
}
