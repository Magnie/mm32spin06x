...
pub type SlvTxAbrtDisR = crate::BitReader;
#[doc = "Field `SLV_TX_ABRT_DIS` writer - when acting as a slave"]
pub type SlvTxAbrtDisW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn slv_tx_abrt_dis(&self) -> SlvTxAbrtDisR {
        SlvTxAbrtDisR::new(((self.bits >> 11) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - This bit controls whether the DW_apb_i2c master is enabled"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn restart(&mut self) -> RestartW<CrSpec> {
        RestartW::new(self, 10)
    }
    #[doc = "Bit 11 - when acting as a slave"]
    #[inline(always)]
    #[must_use]
    pub fn slv_tx_abrt_dis(&mut self) -> SlvTxAbrtDisW<CrSpec> {
        SlvTxAbrtDisW::new(self, 11)
    }
}
