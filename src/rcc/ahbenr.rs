...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma(&mut self) -> DmaW<AhbenrSpec> {
        DmaW::new(self, 0)
    }
    #[doc = "Bit 2 - SRAM interface clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpioc(&mut self) -> GpiocW<AhbenrSpec> {
        GpiocW::new(self, 19)
    }
    #[doc = "Bit 20 - GPIOD clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpiod(&mut self) -> GpiodW<AhbenrSpec> {
        GpiodW::new(self, 20)
    }
    #[doc = "Bit 26 - HWDIV clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn hwdiv(&mut self) -> HwdivW<AhbenrSpec> {
        HwdivW::new(self, 26)
    }
}
