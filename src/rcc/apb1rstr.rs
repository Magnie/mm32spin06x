...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim2(&mut self) -> Tim2W<Apb1rstrSpec> {
        Tim2W::new(self, 0)
    }
    #[doc = "Bit 1 - TIM3 reset"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn wwdg(&mut self) -> WwdgW<Apb1rstrSpec> {
        WwdgW::new(self, 11)
    }
    #[doc = "Bit 14 - SPI2 reset"]
    #[inline(always)]
    #[must_use]
    pub fn spi2(&mut self) -> Spi2W<Apb1rstrSpec> {
        Spi2W::new(self, 14)
    }
    #[doc = "Bit 17 - UART2 reset"]
    #[inline(always)]
    #[must_use]
    pub fn uart2(&mut self) -> Uart2W<Apb1rstrSpec> {
        Uart2W::new(self, 17)
    }
    #[doc = "Bit 21 - I2C1 reset"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb(&mut self) -> UsbW<Apb1rstrSpec> {
        UsbW::new(self, 23)
    }
    #[doc = "Bit 25 - CAN reset"]
    #[inline(always)]
    #[must_use]
    pub fn can(&mut self) -> CanW<Apb1rstrSpec> {
        CanW::new(self, 25)
    }
    #[doc = "Bit 26 - CSM reset"]
    #[inline(always)]
    #[must_use]
    pub fn csm(&mut self) -> CsmW<Apb1rstrSpec> {
        CsmW::new(self, 26)
    }
    #[doc = "Bit 27 - CRS interface reset"]
    #[inline(always)]
    #[must_use]
    pub fn crs(&mut self) -> CrsW<Apb1rstrSpec> {
        CrsW::new(self, 27)
    }
    #[doc = "Bit 28 - Power interface reset"]
    #[inline(always)]
