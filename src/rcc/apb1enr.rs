...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim2(&mut self) -> Tim2W<Apb1enrSpec> {
        Tim2W::new(self, 0)
    }
    #[doc = "Bit 1 - TIM3 clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn wwdg(&mut self) -> WwdgW<Apb1enrSpec> {
        WwdgW::new(self, 11)
    }
    #[doc = "Bit 14 - SPI2 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn spi2(&mut self) -> Spi2W<Apb1enrSpec> {
        Spi2W::new(self, 14)
    }
    #[doc = "Bit 17 - UART2 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn uart2(&mut self) -> Uart2W<Apb1enrSpec> {
        Uart2W::new(self, 17)
    }
    #[doc = "Bit 21 - I2C1 clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb(&mut self) -> UsbW<Apb1enrSpec> {
        UsbW::new(self, 23)
    }
    #[doc = "Bit 25 - CAN 2C1 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn can(&mut self) -> CanW<Apb1enrSpec> {
        CanW::new(self, 25)
    }
    #[doc = "Bit 26 - CSM clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn csm(&mut self) -> CsmW<Apb1enrSpec> {
        CsmW::new(self, 26)
    }
    #[doc = "Bit 27 - CRS clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn crs(&mut self) -> CrsW<Apb1enrSpec> {
        CrsW::new(self, 27)
    }
    #[doc = "Bit 28 - Power interface clock enable"]
    #[inline(always)]
