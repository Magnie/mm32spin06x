...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rng_en(&mut self) -> RngEnW<RngSpec> {
        RngEnW::new(self, 0)
    }
    #[doc = "Bit 1 - RNG load seed"]
    #[inline(always)]
    #[must_use]
    pub fn rng_ldsd(&mut self) -> RngLdsdW<RngSpec> {
        RngLdsdW::new(self, 1)
    }
    #[doc = "Bit 2 - RNG done"]
    #[inline(always)]
    #[must_use]
    pub fn rng_done(&mut self) -> RngDoneW<RngSpec> {
        RngDoneW::new(self, 2)
    }
    #[doc = "Bits 16:31 - RNG data"]
    #[inline(always)]
    #[must_use]
    pub fn rng_data(&mut self) -> RngDataW<RngSpec> {
