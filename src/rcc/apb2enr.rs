...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn syscfg(&mut self) -> SyscfgW<Apb2enrSpec> {
        SyscfgW::new(self, 0)
    }
    #[doc = "Bit 9 - ADC1 interface enable"]
    #[inline(always)]
    #[must_use]
    pub fn adc1(&mut self) -> Adc1W<Apb2enrSpec> {
        Adc1W::new(self, 9)
    }
    #[doc = "Bit 11 - TIM1 Timer clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim1(&mut self) -> Tim1W<Apb2enrSpec> {
        Tim1W::new(self, 11)
    }
    #[doc = "Bit 12 - SPI1 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn spi1(&mut self) -> Spi1W<Apb2enrSpec> {
        Spi1W::new(self, 12)
    }
    #[doc = "Bit 14 - UART1 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn uart1(&mut self) -> Uart1W<Apb2enrSpec> {
        Uart1W::new(self, 14)
    }
    #[doc = "Bit 15 - COMP Comparator enable"]
    #[inline(always)]
    #[must_use]
    pub fn comp(&mut self) -> CompW<Apb2enrSpec> {
        CompW::new(self, 15)
    }
    #[doc = "Bit 16 - TIM14 timer enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim14(&mut self) -> Tim14W<Apb2enrSpec> {
        Tim14W::new(self, 16)
    }
    #[doc = "Bit 17 - TIM16 timer enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim16(&mut self) -> Tim16W<Apb2enrSpec> {
        Tim16W::new(self, 17)
    }
    #[doc = "Bit 18 - TIM17 timer enable"]
    #[inline(always)]
    #[must_use]
    pub fn tim17(&mut self) -> Tim17W<Apb2enrSpec> {
        Tim17W::new(self, 18)
    }
    #[doc = "Bit 22 - DBGMCU enable"]
    #[inline(always)]
    #[must_use]
    pub fn dbgmcu(&mut self) -> DbgmcuW<Apb2enrSpec> {
        DbgmcuW::new(self, 22)
    }
}
