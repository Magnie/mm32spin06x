...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep0en(&mut self) -> Ep0enW<EpEnSpec> {
        Ep0enW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable End Point 1"]
    #[inline(always)]
    #[must_use]
    pub fn ep1en(&mut self) -> Ep1enW<EpEnSpec> {
        Ep1enW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable End Point 2"]
    #[inline(always)]
    #[must_use]
    pub fn ep2en(&mut self) -> Ep2enW<EpEnSpec> {
        Ep2enW::new(self, 2)
    }
    #[doc = "Bit 3 - Enable End Point 3"]
    #[inline(always)]
    #[must_use]
    pub fn ep3en(&mut self) -> Ep3enW<EpEnSpec> {
        Ep3enW::new(self, 3)
    }
    #[doc = "Bit 4 - Enable End Point 4"]
    #[inline(always)]
    #[must_use]
    pub fn ep4en(&mut self) -> Ep4enW<EpEnSpec> {
        Ep4enW::new(self, 4)
    }
}
