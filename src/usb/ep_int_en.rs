...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep0ie(&mut self) -> Ep0ieW<EpIntEnSpec> {
        Ep0ieW::new(self, 0)
    }
    #[doc = "Bit 1 - EP1 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ep1ie(&mut self) -> Ep1ieW<EpIntEnSpec> {
        Ep1ieW::new(self, 1)
    }
    #[doc = "Bit 2 - EP2 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ep2ie(&mut self) -> Ep2ieW<EpIntEnSpec> {
        Ep2ieW::new(self, 2)
    }
    #[doc = "Bit 3 - EP3 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ep3ie(&mut self) -> Ep3ieW<EpIntEnSpec> {
        Ep3ieW::new(self, 3)
    }
    #[doc = "Bit 4 - EP4 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ep4ie(&mut self) -> Ep4ieW<EpIntEnSpec> {
        Ep4ieW::new(self, 4)
    }
}
