#[doc = "Register `EP4_INT_STATE` reader"]
pub type R = crate::R<Ep4IntStateSpec>;
#[doc = "Register `EP4_INT_STATE` writer"]
pub type W = crate::W<Ep4IntStateSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn end(&mut self) -> EndW<Ep4IntStateSpec> {
        EndW::new(self, 1)
    }
    #[doc = "Bit 2 - IN-NACK received"]
    #[inline(always)]
    #[must_use]
    pub fn in_nacf(&mut self) -> InNacfW<Ep4IntStateSpec> {
        InNacfW::new(self, 2)
    }
    #[doc = "Bit 3 - IN-ACK received"]
    #[inline(always)]
    #[must_use]
    pub fn in_ackf(&mut self) -> InAckfW<Ep4IntStateSpec> {
        InAckfW::new(self, 3)
    }
    #[doc = "Bit 4 - IN-STALL received"]
    #[inline(always)]
    #[must_use]
    pub fn in_stallf(&mut self) -> InStallfW<Ep4IntStateSpec> {
        InStallfW::new(self, 4)
    }
    #[doc = "Bit 5 - OUT-NACK received"]
    #[inline(always)]
    #[must_use]
    pub fn out_nackf(&mut self) -> OutNackfW<Ep4IntStateSpec> {
        OutNackfW::new(self, 5)
    }
    #[doc = "Bit 6 - OUT-ACK received"]
    #[inline(always)]
    #[must_use]
    pub fn out_ackf(&mut self) -> OutAckfW<Ep4IntStateSpec> {
        OutAckfW::new(self, 6)
    }
    #[doc = "Bit 7 - OUT-STALL received"]
    #[inline(always)]
    #[must_use]
    pub fn out_stallf(&mut self) -> OutStallfW<Ep4IntStateSpec> {
...
pub struct Ep4IntStateSpec;
impl crate::RegisterSpec for Ep4IntStateSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ep4_int_state::R`](R) reader structure"]
impl crate::Readable for Ep4IntStateSpec {}
#[doc = "`write(|w| ..)` method takes [`ep4_int_state::W`](W) writer structure"]
impl crate::Writable for Ep4IntStateSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets EP4_INT_STATE to value 0"]
impl crate::Resettable for Ep4IntStateSpec {
