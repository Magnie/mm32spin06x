...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn in_tog1(&mut self) -> InTog1W<TogStat1_4Spec> {
        InTog1W::new(self, 0)
    }
    #[doc = "Bit 1 - End Point 1 Toggle ON State"]
    #[inline(always)]
    #[must_use]
    pub fn out_tog1(&mut self) -> OutTog1W<TogStat1_4Spec> {
        OutTog1W::new(self, 1)
    }
    #[doc = "Bit 2 - End Point 2 Toggle IN State"]
    #[inline(always)]
    #[must_use]
    pub fn in_tog2(&mut self) -> InTog2W<TogStat1_4Spec> {
        InTog2W::new(self, 2)
    }
    #[doc = "Bit 3 - End Point 2 Toggle ON State"]
    #[inline(always)]
    #[must_use]
    pub fn out_tog2(&mut self) -> OutTog2W<TogStat1_4Spec> {
        OutTog2W::new(self, 3)
    }
    #[doc = "Bit 4 - End Point 3 Toggle IN State"]
    #[inline(always)]
    #[must_use]
    pub fn in_tog3(&mut self) -> InTog3W<TogStat1_4Spec> {
        InTog3W::new(self, 4)
    }
    #[doc = "Bit 5 - End Point 3 Toggle ON State"]
    #[inline(always)]
    #[must_use]
    pub fn out_tog3(&mut self) -> OutTog3W<TogStat1_4Spec> {
        OutTog3W::new(self, 5)
    }
    #[doc = "Bit 6 - End Point 4 Toggle IN State"]
    #[inline(always)]
    #[must_use]
    pub fn in_tog4(&mut self) -> InTog4W<TogStat1_4Spec> {
        InTog4W::new(self, 6)
    }
    #[doc = "Bit 7 - End Point 4 Toggle ON State"]
    #[inline(always)]
    #[must_use]
    pub fn out_tog4(&mut self) -> OutTog4W<TogStat1_4Spec> {
        OutTog4W::new(self, 7)
    }
}
