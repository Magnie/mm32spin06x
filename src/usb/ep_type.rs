...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep1_type(&mut self) -> Ep1TypeW<EpTypeSpec> {
        Ep1TypeW::new(self, 0)
    }
    #[doc = "Bit 1 - Point 2 type"]
    #[inline(always)]
    #[must_use]
    pub fn ep2_type(&mut self) -> Ep2TypeW<EpTypeSpec> {
        Ep2TypeW::new(self, 1)
    }
    #[doc = "Bit 2 - Point 3 type"]
    #[inline(always)]
    #[must_use]
    pub fn ep3_type(&mut self) -> Ep3TypeW<EpTypeSpec> {
        Ep3TypeW::new(self, 2)
    }
    #[doc = "Bit 3 - Point 4 type"]
    #[inline(always)]
    #[must_use]
    pub fn ep4_type(&mut self) -> Ep4TypeW<EpTypeSpec> {
        Ep4TypeW::new(self, 3)
    }
}
