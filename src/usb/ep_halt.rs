...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn halt0(&mut self) -> Halt0W<EpHaltSpec> {
        Halt0W::new(self, 0)
    }
    #[doc = "Bit 1 - EP1 halt"]
    #[inline(always)]
    #[must_use]
    pub fn halt1(&mut self) -> Halt1W<EpHaltSpec> {
        Halt1W::new(self, 1)
    }
    #[doc = "Bit 2 - EP2 halt"]
    #[inline(always)]
    #[must_use]
    pub fn halt2(&mut self) -> Halt2W<EpHaltSpec> {
        Halt2W::new(self, 2)
    }
    #[doc = "Bit 3 - EP3 halt"]
    #[inline(always)]
    #[must_use]
    pub fn halt3(&mut self) -> Halt3W<EpHaltSpec> {
        Halt3W::new(self, 3)
    }
    #[doc = "Bit 4 - EP4 halt"]
    #[inline(always)]
    #[must_use]
    pub fn halt4(&mut self) -> Halt4W<EpHaltSpec> {
        Halt4W::new(self, 4)
    }
}
