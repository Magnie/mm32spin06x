...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtog1(&mut self) -> Dtog1W<TogCtrl1_4Spec> {
        Dtog1W::new(self, 0)
    }
    #[doc = "Bit 1 - Set End Point 1 enable"]
    #[inline(always)]
    #[must_use]
    pub fn dtog1en(&mut self) -> Dtog1enW<TogCtrl1_4Spec> {
        Dtog1enW::new(self, 1)
    }
    #[doc = "Bit 2 - Set End Point 2 Toggle"]
    #[inline(always)]
    #[must_use]
    pub fn dtog2(&mut self) -> Dtog2W<TogCtrl1_4Spec> {
        Dtog2W::new(self, 2)
    }
    #[doc = "Bit 3 - Set End Point 2 enable"]
    #[inline(always)]
    #[must_use]
    pub fn dtog2en(&mut self) -> Dtog2enW<TogCtrl1_4Spec> {
        Dtog2enW::new(self, 3)
    }
    #[doc = "Bit 4 - Set End Point 3 Toggle"]
    #[inline(always)]
    #[must_use]
    pub fn dtog3(&mut self) -> Dtog3W<TogCtrl1_4Spec> {
        Dtog3W::new(self, 4)
    }
    #[doc = "Bit 5 - Set End Point 3 enable"]
    #[inline(always)]
    #[must_use]
    pub fn dtog3en(&mut self) -> Dtog3enW<TogCtrl1_4Spec> {
        Dtog3enW::new(self, 5)
    }
    #[doc = "Bit 6 - Set End Point 4 Toggle"]
    #[inline(always)]
    #[must_use]
    pub fn dtog4(&mut self) -> Dtog4W<TogCtrl1_4Spec> {
        Dtog4W::new(self, 6)
    }
    #[doc = "Bit 7 - Set End Point 4 enable"]
    #[inline(always)]
    #[must_use]
    pub fn dtog4en(&mut self) -> Dtog4enW<TogCtrl1_4Spec> {
        Dtog4enW::new(self, 7)
    }
}
