...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep0(&mut self) -> Ep0W<UsbAhbRstSpec> {
        Ep0W::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint 1 reset"]
    #[inline(always)]
    #[must_use]
    pub fn ep1(&mut self) -> Ep1W<UsbAhbRstSpec> {
        Ep1W::new(self, 1)
    }
    #[doc = "Bit 2 - Endpoint 2 reset"]
    #[inline(always)]
    #[must_use]
    pub fn ep2(&mut self) -> Ep2W<UsbAhbRstSpec> {
        Ep2W::new(self, 2)
    }
    #[doc = "Bit 3 - Endpoint 3 reset"]
    #[inline(always)]
    #[must_use]
    pub fn ep3(&mut self) -> Ep3W<UsbAhbRstSpec> {
        Ep3W::new(self, 3)
    }
}
