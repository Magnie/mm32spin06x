...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0_bs(&mut self) -> Ch0BsW<UsbAhbDmaSpec> {
        Ch0BsW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Channel 1 burst set"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_bs(&mut self) -> Ch1BsW<UsbAhbDmaSpec> {
        Ch1BsW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Channel 2 burst set"]
    #[inline(always)]
    #[must_use]
    pub fn ch2_bs(&mut self) -> Ch2BsW<UsbAhbDmaSpec> {
        Ch2BsW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Channel 3 burst set"]
    #[inline(always)]
    #[must_use]
    pub fn ch3_bs(&mut self) -> Ch3BsW<UsbAhbDmaSpec> {
        Ch3BsW::new(self, 6)
    }
}
