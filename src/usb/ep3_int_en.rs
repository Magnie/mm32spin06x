#[doc = "Register `EP3_INT_EN` reader"]
pub type R = crate::R<Ep3IntEnSpec>;
#[doc = "Register `EP3_INT_EN` writer"]
pub type W = crate::W<Ep3IntEnSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn endie(&mut self) -> EndieW<Ep3IntEnSpec> {
        EndieW::new(self, 1)
    }
    #[doc = "Bit 2 - IN-NACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn in_nackie(&mut self) -> InNackieW<Ep3IntEnSpec> {
        InNackieW::new(self, 2)
    }
    #[doc = "Bit 3 - IN-ACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn in_ackie(&mut self) -> InAckieW<Ep3IntEnSpec> {
        InAckieW::new(self, 3)
    }
    #[doc = "Bit 4 - IN-STALL interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn in_stallie(&mut self) -> InStallieW<Ep3IntEnSpec> {
        InStallieW::new(self, 4)
    }
    #[doc = "Bit 5 - OUT-NACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn out_nackie(&mut self) -> OutNackieW<Ep3IntEnSpec> {
        OutNackieW::new(self, 5)
    }
    #[doc = "Bit 6 - OUT-ACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn out_ackie(&mut self) -> OutAckieW<Ep3IntEnSpec> {
        OutAckieW::new(self, 6)
    }
    #[doc = "Bit 7 - OUT-STALL interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn out_stallie(&mut self) -> OutStallieW<Ep3IntEnSpec> {
        OutStallieW::new(self, 7)
    }
}
#[doc = "EP3 interrupt enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`ep3_int_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ep3_int_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ep3IntEnSpec;
impl crate::RegisterSpec for Ep3IntEnSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ep3_int_en::R`](R) reader structure"]
impl crate::Readable for Ep3IntEnSpec {}
#[doc = "`write(|w| ..)` method takes [`ep3_int_en::W`](W) writer structure"]
impl crate::Writable for Ep3IntEnSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets EP3_INT_EN to value 0"]
impl crate::Resettable for Ep3IntEnSpec {
