...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rstf(&mut self) -> RstfW<IntStateSpec> {
        RstfW::new(self, 0)
    }
    #[doc = "Bit 1 - BUS suspend received"]
    #[inline(always)]
    #[must_use]
    pub fn suspendf(&mut self) -> SuspendfW<IntStateSpec> {
        SuspendfW::new(self, 1)
    }
    #[doc = "Bit 2 - BUS resume received"]
    #[inline(always)]
    #[must_use]
    pub fn resumf(&mut self) -> ResumfW<IntStateSpec> {
        ResumfW::new(self, 2)
    }
    #[doc = "Bit 3 - BUS received"]
    #[inline(always)]
    #[must_use]
    pub fn soff(&mut self) -> SoffW<IntStateSpec> {
        SoffW::new(self, 3)
    }
    #[doc = "Bit 4 - EP interrupt received"]
    #[inline(always)]
    #[must_use]
    pub fn epintf(&mut self) -> EpintfW<IntStateSpec> {
        EpintfW::new(self, 4)
    }
}
