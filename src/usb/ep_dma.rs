...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma0en(&mut self) -> Dma0enW<EpDmaSpec> {
        Dma0enW::new(self, 0)
    }
    #[doc = "Bit 1 - EP1 DMA enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma1en(&mut self) -> Dma1enW<EpDmaSpec> {
        Dma1enW::new(self, 1)
    }
    #[doc = "Bit 2 - EP2 DMA enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma2en(&mut self) -> Dma2enW<EpDmaSpec> {
        Dma2enW::new(self, 2)
    }
    #[doc = "Bit 3 - EP3 DMA enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma3en(&mut self) -> Dma3enW<EpDmaSpec> {
        Dma3enW::new(self, 3)
    }
    #[doc = "Bit 4 - EP4 DMA enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma4en(&mut self) -> Dma4enW<EpDmaSpec> {
        Dma4enW::new(self, 4)
    }
}
