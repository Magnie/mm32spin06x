...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dam_dir1(&mut self) -> DamDir1W<EpDmaDirSpec> {
        DamDir1W::new(self, 0)
    }
    #[doc = "Bit 1 - Point 2 Dma Dir"]
    #[inline(always)]
    #[must_use]
    pub fn dam_dir2(&mut self) -> DamDir2W<EpDmaDirSpec> {
        DamDir2W::new(self, 1)
    }
    #[doc = "Bit 2 - Point 3 Dma Dir"]
    #[inline(always)]
    #[must_use]
    pub fn dam_dir3(&mut self) -> DamDir3W<EpDmaDirSpec> {
        DamDir3W::new(self, 2)
    }
    #[doc = "Bit 3 - Point 4 Dma Dir"]
    #[inline(always)]
    #[must_use]
    pub fn dam_dir4(&mut self) -> DamDir4W<EpDmaDirSpec> {
        DamDir4W::new(self, 3)
    }
}
