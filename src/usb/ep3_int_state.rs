...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn end(&mut self) -> EndW<Ep3IntStateSpec> {
        EndW::new(self, 1)
    }
    #[doc = "Bit 2 - IN-NACK received"]
    #[inline(always)]
    #[must_use]
    pub fn in_nacf(&mut self) -> InNacfW<Ep3IntStateSpec> {
        InNacfW::new(self, 2)
    }
    #[doc = "Bit 3 - IN-ACK received"]
    #[inline(always)]
    #[must_use]
    pub fn in_ackf(&mut self) -> InAckfW<Ep3IntStateSpec> {
        InAckfW::new(self, 3)
    }
    #[doc = "Bit 4 - IN-STALL received"]
    #[inline(always)]
    #[must_use]
    pub fn in_stallf(&mut self) -> InStallfW<Ep3IntStateSpec> {
        InStallfW::new(self, 4)
    }
    #[doc = "Bit 5 - OUT-NACK received"]
    #[inline(always)]
    #[must_use]
    pub fn out_nackf(&mut self) -> OutNackfW<Ep3IntStateSpec> {
        OutNackfW::new(self, 5)
    }
    #[doc = "Bit 6 - OUT-ACK received"]
    #[inline(always)]
    #[must_use]
    pub fn out_ackf(&mut self) -> OutAckfW<Ep3IntStateSpec> {
        OutAckfW::new(self, 6)
    }
    #[doc = "Bit 7 - OUT-STALL received"]
    #[inline(always)]
    #[must_use]
    pub fn out_stallf(&mut self) -> OutStallfW<Ep3IntStateSpec> {
