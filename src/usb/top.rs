...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn speed(&mut self) -> SpeedW<TopSpec> {
        SpeedW::new(self, 0)
    }
    #[doc = "Bit 1 - USB connection"]
    #[inline(always)]
    #[must_use]
    pub fn connect(&mut self) -> ConnectW<TopSpec> {
        ConnectW::new(self, 1)
    }
    #[doc = "Bit 3 - Reset EP and FIFO in USB controller"]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> ResetW<TopSpec> {
        ResetW::new(self, 3)
    }
    #[doc = "Bit 4 - USB suspend state"]
    #[inline(always)]
    #[must_use]
    pub fn suspend(&mut self) -> SuspendW<TopSpec> {
        SuspendW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Current USB DP/DM line state"]
    #[inline(always)]
    #[must_use]
    pub fn dp_dmstate(&mut self) -> DpDmstateW<TopSpec> {
        DpDmstateW::new(self, 5)
    }
    #[doc = "Bit 7 - USB bus is active"]
    #[inline(always)]
    #[must_use]
    pub fn active(&mut self) -> ActiveW<TopSpec> {
        ActiveW::new(self, 7)
    }
}
