...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn endie(&mut self) -> EndieW<Ep4IntEnSpec> {
        EndieW::new(self, 1)
    }
    #[doc = "Bit 2 - IN-NACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn in_nackie(&mut self) -> InNackieW<Ep4IntEnSpec> {
        InNackieW::new(self, 2)
    }
    #[doc = "Bit 3 - IN-ACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn in_ackie(&mut self) -> InAckieW<Ep4IntEnSpec> {
        InAckieW::new(self, 3)
    }
    #[doc = "Bit 4 - IN-STALL interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn in_stallie(&mut self) -> InStallieW<Ep4IntEnSpec> {
        InStallieW::new(self, 4)
    }
    #[doc = "Bit 5 - OUT-NACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn out_nackie(&mut self) -> OutNackieW<Ep4IntEnSpec> {
        OutNackieW::new(self, 5)
    }
    #[doc = "Bit 6 - OUT-ACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn out_ackie(&mut self) -> OutAckieW<Ep4IntEnSpec> {
        OutAckieW::new(self, 6)
    }
    #[doc = "Bit 7 - OUT-STALL interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn out_stallie(&mut self) -> OutStallieW<Ep4IntEnSpec> {
