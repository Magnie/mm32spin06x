...
#[doc = "Field `CC5DE` reader - Capture/Compare 5 DMA request enable"]
pub type Cc5deR = crate::BitReader;
#[doc = "Field `CC5DE` writer - Capture/Compare 5 DMA request enable"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc5de(&mut self) -> Cc5deW<DierSpec> {
        Cc5deW::new(self, 17)
    }
}
