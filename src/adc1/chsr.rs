...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chen0(&mut self) -> Chen0W<ChsrSpec> {
        Chen0W::new(self, 0)
    }
    #[doc = "Bit 1 - Analog input channel 1 enable"]
    #[inline(always)]
    #[must_use]
    pub fn chen1(&mut self) -> Chen1W<ChsrSpec> {
        Chen1W::new(self, 1)
    }
    #[doc = "Bit 2 - Analog input channel 2 enable"]
    #[inline(always)]
    #[must_use]
    pub fn chen2(&mut self) -> Chen2W<ChsrSpec> {
        Chen2W::new(self, 2)
    }
    #[doc = "Bit 3 - Analog input channel 3 enable"]
    #[inline(always)]
    #[must_use]
    pub fn chen3(&mut self) -> Chen3W<ChsrSpec> {
        Chen3W::new(self, 3)
    }
    #[doc = "Bit 4 - Analog input channel 4 enable"]
    #[inline(always)]
    #[must_use]
    pub fn chen4(&mut self) -> Chen4W<ChsrSpec> {
        Chen4W::new(self, 4)
    }
    #[doc = "Bit 5 - Analog input channel 5 enable"]
    #[inline(always)]
    #[must_use]
    pub fn chen5(&mut self) -> Chen5W<ChsrSpec> {
        Chen5W::new(self, 5)
    }
    #[doc = "Bit 6 - Analog input channel 6 enable"]
    #[inline(always)]
    #[must_use]
    pub fn chen6(&mut self) -> Chen6W<ChsrSpec> {
        Chen6W::new(self, 6)
    }
    #[doc = "Bit 7 - Analog input channel 7 enable"]
    #[inline(always)]
    #[must_use]
    pub fn chen7(&mut self) -> Chen7W<ChsrSpec> {
        Chen7W::new(self, 7)
    }
    #[doc = "Bit 8 - Analog input channel 8 enable"]
    #[inline(always)]
    #[must_use]
    pub fn chen8(&mut self) -> Chen8W<ChsrSpec> {
        Chen8W::new(self, 8)
    }
    #[doc = "Bit 9 - Analog input channel 9 enable"]
    #[inline(always)]
    #[must_use]
    pub fn chen9(&mut self) -> Chen9W<ChsrSpec> {
        Chen9W::new(self, 9)
    }
    #[doc = "Bit 14 - Temperature Sensor channel enable"]
    #[inline(always)]
    #[must_use]
    pub fn chents(&mut self) -> ChentsW<ChsrSpec> {
        ChentsW::new(self, 14)
    }
    #[doc = "Bit 15 - Internal reference voltage channel enable"]
    #[inline(always)]
    #[must_use]
    pub fn chenvs(&mut self) -> ChenvsW<ChsrSpec> {
        ChenvsW::new(self, 15)
    }
}
