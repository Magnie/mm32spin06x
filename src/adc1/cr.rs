...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adie(&mut self) -> AdieW<CrSpec> {
        AdieW::new(self, 0)
    }
    #[doc = "Bit 1 - ADC window comparator interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn adwie(&mut self) -> AdwieW<CrSpec> {
        AdwieW::new(self, 1)
    }
    #[doc = "Bit 2 - External trigger enable"]
    #[inline(always)]
    #[must_use]
    pub fn trgen(&mut self) -> TrgenW<CrSpec> {
        TrgenW::new(self, 2)
    }
    #[doc = "Bit 3 - Direct memory access enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn trgsell(&mut self) -> TrgsellW<CrSpec> {
        TrgsellW::new(self, 4)
    }
    #[doc = "Bit 8 - ADC start"]
    #[inline(always)]
    #[must_use]
    pub fn adst(&mut self) -> AdstW<CrSpec> {
        AdstW::new(self, 8)
    }
    #[doc = "Bits 9:10 - ADC mode"]
    #[inline(always)]
    #[must_use]
    pub fn admd(&mut self) -> AdmdW<CrSpec> {
        AdmdW::new(self, 9)
    }
    #[doc = "Bit 11 - Data alignment"]
    #[inline(always)]
    #[must_use]
    pub fn align(&mut self) -> AlignW<CrSpec> {
        AlignW::new(self, 11)
    }
    #[doc = "Bits 12:15 - Window comparison channel selection"]
    #[inline(always)]
    #[must_use]
    pub fn cmpch(&mut self) -> CmpchW<CrSpec> {
        CmpchW::new(self, 12)
    }
    #[doc = "Bit 16 - ADC scan direction"]
    #[inline(always)]
    #[must_use]
    pub fn scandir(&mut self) -> ScandirW<CrSpec> {
        ScandirW::new(self, 16)
    }
    #[doc = "Bits 17:18 - External trigger selection high"]
    #[inline(always)]
    #[must_use]
    pub fn trgselh(&mut self) -> TrgselhW<CrSpec> {
        TrgselhW::new(self, 17)
    }
    #[doc = "Bits 19:21 - External trigger shift sample"]
    #[inline(always)]
    #[must_use]
    pub fn trgshift(&mut self) -> TrgshiftW<CrSpec> {
        TrgshiftW::new(self, 19)
    }
    #[doc = "Bits 24:25 - Trigger edge selection"]
    #[inline(always)]
    #[must_use]
    pub fn trg_edge(&mut self) -> TrgEdgeW<CrSpec> {
