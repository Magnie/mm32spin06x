...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txien(&mut self) -> TxienW<IerSpec> {
        TxienW::new(self, 0)
    }
    #[doc = "Bit 1 - Receive buffer interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn rxien(&mut self) -> RxienW<IerSpec> {
        RxienW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit complete interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn txc_ien(&mut self) -> TxcIenW<IerSpec> {
        TxcIenW::new(self, 2)
    }
    #[doc = "Bit 3 - Receive overflow error interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn rxoerren(&mut self) -> RxoerrenW<IerSpec> {
        RxoerrenW::new(self, 3)
    }
    #[doc = "Bit 4 - Parity error interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn rxperren(&mut self) -> RxperrenW<IerSpec> {
        RxperrenW::new(self, 4)
    }
    #[doc = "Bit 5 - Frame error interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn rxferren(&mut self) -> RxferrenW<IerSpec> {
        RxferrenW::new(self, 5)
    }
    #[doc = "Bit 6 - Receive frame break interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn rxbrken(&mut self) -> RxbrkenW<IerSpec> {
        RxbrkenW::new(self, 6)
    }
    #[doc = "Bit 7 - Transmit Break Frame Interrupt Enable Bit"]
    #[inline(always)]
    #[must_use]
    pub fn txbrk_ien(&mut self) -> TxbrkIenW<IerSpec> {
        TxbrkIenW::new(self, 7)
    }
    #[doc = "Bit 8 - Receive Bit 8 Interrupt Enable Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rxb8_ien(&mut self) -> Rxb8IenW<IerSpec> {
        Rxb8IenW::new(self, 8)
    }
    #[doc = "Bit 9 - Receive frame idle interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn rxidlen(&mut self) -> RxidlenW<IerSpec> {
        RxidlenW::new(self, 9)
    }
    #[doc = "Bit 10 - Automatic baud rate end interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn abrend_ien(&mut self) -> AbrendIenW<IerSpec> {
        AbrendIenW::new(self, 10)
    }
    #[doc = "Bit 11 - Automatic baud rate error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn abrerr_ien(&mut self) -> AbrerrIenW<IerSpec> {
