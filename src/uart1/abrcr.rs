...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn abren(&mut self) -> AbrenW<AbrcrSpec> {
        AbrenW::new(self, 0)
    }
    #[doc = "Bits 1:2 - Automatic baud rate detection length"]
    #[inline(always)]
    #[must_use]
    pub fn abr_bitcnt(&mut self) -> AbrBitcntW<AbrcrSpec> {
        AbrBitcntW::new(self, 1)
    }
    #[doc = "Bit 3 - Auto baud rate previous edge selection"]
    #[inline(always)]
    #[must_use]
    pub fn former_edge(&mut self) -> FormerEdgeW<AbrcrSpec> {
        FormerEdgeW::new(self, 3)
    }
    #[doc = "Bit 4 - Automatic baud rate after edge selection"]
    #[inline(always)]
    #[must_use]
    pub fn later_edge(&mut self) -> LaterEdgeW<AbrcrSpec> {
