...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scen(&mut self) -> ScenW<ScrSpec> {
        ScenW::new(self, 0)
    }
    #[doc = "Bit 1 - ISO7816 check auto-response bit"]
    #[inline(always)]
    #[must_use]
    pub fn scaen(&mut self) -> ScaenW<ScrSpec> {
        ScaenW::new(self, 1)
    }
    #[doc = "Bit 2 - Master receive frame answer bit"]
    #[inline(always)]
    #[must_use]
    pub fn nack(&mut self) -> NackW<ScrSpec> {
        NackW::new(self, 2)
    }
    #[doc = "Bits 4:11 - ISO7816 protection counter bit"]
    #[inline(always)]
    #[must_use]
    pub fn scfcnt(&mut self) -> ScfcntW<ScrSpec> {
        ScfcntW::new(self, 4)
    }
    #[doc = "Bit 12 - Single-wire half-duplex mode selection bit"]
    #[inline(always)]
    #[must_use]
    pub fn hdsel(&mut self) -> HdselW<ScrSpec> {
        HdselW::new(self, 12)
    }
}
