...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pen(&mut self) -> PenW<CcrSpec> {
        PenW::new(self, 0)
    }
    #[doc = "Bit 1 - Parity selection bit"]
    #[inline(always)]
    #[must_use]
    pub fn psel(&mut self) -> PselW<CcrSpec> {
        PselW::new(self, 1)
    }
    #[doc = "Bit 2 - Stop bit 0 selection"]
    #[inline(always)]
    #[must_use]
    pub fn spb0(&mut self) -> Spb0W<CcrSpec> {
        Spb0W::new(self, 2)
    }
    #[doc = "Bit 3 - UART transmit frame break"]
    #[inline(always)]
    #[must_use]
    pub fn brk(&mut self) -> BrkW<CcrSpec> {
        BrkW::new(self, 3)
    }
    #[doc = "Bits 4:5 - UART width bit"]
    #[inline(always)]
    #[must_use]
    pub fn char(&mut self) -> CharW<CcrSpec> {
        CharW::new(self, 4)
    }
    #[doc = "Bit 6 - Stop bit 1 selection bit"]
    #[inline(always)]
    #[must_use]
    pub fn spb1(&mut self) -> Spb1W<CcrSpec> {
        Spb1W::new(self, 6)
    }
    #[doc = "Bit 7 - Synchronous frame receive"]
    #[inline(always)]
    #[must_use]
    pub fn b8rxd(&mut self) -> B8rxdW<CcrSpec> {
        B8rxdW::new(self, 7)
    }
    #[doc = "Bit 8 - Synchronous frame transmit"]
    #[inline(always)]
    #[must_use]
    pub fn b8txd(&mut self) -> B8txdW<CcrSpec> {
        B8txdW::new(self, 8)
    }
    #[doc = "Bit 9 - Synchronous frame polarity control bit"]
    #[inline(always)]
    #[must_use]
    pub fn b8pol(&mut self) -> B8polW<CcrSpec> {
        B8polW::new(self, 9)
    }
    #[doc = "Bit 10 - Synchronous frame auto toggle bit"]
    #[inline(always)]
    #[must_use]
    pub fn b8tog(&mut self) -> B8togW<CcrSpec> {
        B8togW::new(self, 10)
    }
    #[doc = "Bit 11 - Synchronous frame enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn b8en(&mut self) -> B8enW<CcrSpec> {
        B8enW::new(self, 11)
    }
    #[doc = "Bit 12 - Receive wake up method"]
    #[inline(always)]
    #[must_use]
    pub fn rwu(&mut self) -> RwuW<CcrSpec> {
        RwuW::new(self, 12)
    }
    #[doc = "Bit 13 - Wake up method"]
    #[inline(always)]
    #[must_use]
    pub fn wake(&mut self) -> WakeW<CcrSpec> {
        WakeW::new(self, 13)
    }
    #[doc = "Bit 14 - UART LIN enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn lin(&mut self) -> LinW<CcrSpec> {
        LinW::new(self, 14)
    }
}
