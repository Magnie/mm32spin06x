...
#[doc = "Field `SWIER24` reader - Software interrupt on line 24"]
pub type Swier24R = crate::BitReader;
#[doc = "Field `SWIER24` writer - Software interrupt on line 24"]
pub type Swier24W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn swier24(&self) -> Swier24R {
        Swier24R::new(((self.bits >> 24) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Software interrupt on line 0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn swier24(&mut self) -> Swier24W<SwierSpec> {
        Swier24W::new(self, 24)
    }
}
