...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pa11_rermp(&mut self) -> Pa11RermpW<CfgrSpec> {
        Pa11RermpW::new(self, 3)
    }
    #[doc = "Bit 4 - PA12 DMA remap"]
    #[inline(always)]
    #[must_use]
    pub fn pa12_rermp(&mut self) -> Pa12RermpW<CfgrSpec> {
        Pa12RermpW::new(self, 4)
    }
    #[doc = "Bit 8 - ADC DMA remap"]
    #[inline(always)]
    #[must_use]
    pub fn adc_dma_rmp(&mut self) -> AdcDmaRmpW<CfgrSpec> {
        AdcDmaRmpW::new(self, 8)
    }
    #[doc = "Bit 9 - UART1 TX DMA remap"]
    #[inline(always)]
    #[must_use]
    pub fn uart1_tx_dma_rmp(&mut self) -> Uart1TxDmaRmpW<CfgrSpec> {
        Uart1TxDmaRmpW::new(self, 9)
    }
    #[doc = "Bit 10 - UART1 RX DMA remap"]
    #[inline(always)]
    #[must_use]
    pub fn uart1_rx_dma_rmp(&mut self) -> Uart1RxDmaRmpW<CfgrSpec> {
        Uart1RxDmaRmpW::new(self, 10)
    }
    #[doc = "Bit 11 - Timer 16 DMA remap"]
    #[inline(always)]
    #[must_use]
    pub fn tim16_dma_rmp(&mut self) -> Tim16DmaRmpW<CfgrSpec> {
        Tim16DmaRmpW::new(self, 11)
    }
    #[doc = "Bit 12 - Timer 17 DMA remap"]
    #[inline(always)]
    #[must_use]
    pub fn tim17_dma_rmp(&mut self) -> Tim17DmaRmpW<CfgrSpec> {
        Tim17DmaRmpW::new(self, 12)
    }
    #[doc = "Bit 13 - CSMCH2 DMA remap"]
    #[inline(always)]
    #[must_use]
    pub fn csmch2_dma_rmp(&mut self) -> Csmch2DmaRmpW<CfgrSpec> {
        Csmch2DmaRmpW::new(self, 13)
    }
    #[doc = "Bit 14 - CSMCH1 DMA remap"]
    #[inline(always)]
    #[must_use]
    pub fn csmch1_dma_rmp(&mut self) -> Csmch1DmaRmpW<CfgrSpec> {
        Csmch1DmaRmpW::new(self, 14)
    }
    #[doc = "Bit 15 - PA11 PA12 remap"]
    #[inline(always)]
    #[must_use]
    pub fn pa11_pa12_rmp(&mut self) -> Pa11Pa12RmpW<CfgrSpec> {
