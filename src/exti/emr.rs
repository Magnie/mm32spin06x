...
impl R {
    ...
    #[inline(always)]
    pub fn emr18(&self) -> Emr18R {
        Emr18R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - Event Mask on line 19"]
    #[inline(always)]
    pub fn emr19(&self) -> Emr19R {
        Emr19R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - Event Mask on line 20"]
    #[inline(always)]
    pub fn emr20(&self) -> Emr20R {
        Emr20R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 24 - Event Mask on line 24"]
    #[inline(always)]
    pub fn emr24(&self) -> Emr24R {
        Emr24R::new(((self.bits >> 24) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Event Mask on line 0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn emr18(&mut self) -> Emr18W<EmrSpec> {
        Emr18W::new(self, 18)
    }
    #[doc = "Bit 19 - Event Mask on line 19"]
    #[inline(always)]
    #[must_use]
    pub fn emr19(&mut self) -> Emr19W<EmrSpec> {
        Emr19W::new(self, 19)
    }
    #[doc = "Bit 20 - Event Mask on line 20"]
    #[inline(always)]
    #[must_use]
    pub fn emr20(&mut self) -> Emr20W<EmrSpec> {
        Emr20W::new(self, 20)
    }
    #[doc = "Bit 24 - Event Mask on line 24"]
    #[inline(always)]
    #[must_use]
    pub fn emr24(&mut self) -> Emr24W<EmrSpec> {
        Emr24W::new(self, 24)
    }
}
