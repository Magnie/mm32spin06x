...
pub type Imr18R = crate::BitReader;
#[doc = "Field `IMR18` writer - Interrupt Mask on line 18"]
pub type Imr18W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Imr20R = crate::BitReader;
#[doc = "Field `IMR20` writer - Interrupt Mask on line 20"]
pub type Imr20W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn imr18(&self) -> Imr18R {
        Imr18R::new(((self.bits >> 18) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn imr20(&self) -> Imr20R {
        Imr20R::new(((self.bits >> 20) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn imr18(&mut self) -> Imr18W<ImrSpec> {
        Imr18W::new(self, 18)
    }
    #[doc = "Bit 19 - Interrupt Mask on line 19"]
    #[inline(always)]
    #[must_use]
    pub fn imr19(&mut self) -> Imr19W<ImrSpec> {
        Imr19W::new(self, 19)
    }
    #[doc = "Bit 20 - Interrupt Mask on line 20"]
    #[inline(always)]
    #[must_use]
    pub fn imr20(&mut self) -> Imr20W<ImrSpec> {
        Imr20W::new(self, 20)
    }
    #[doc = "Bit 24 - Interrupt Mask on line 24"]
    #[inline(always)]
    #[must_use]
    pub fn imr24(&mut self) -> Imr24W<ImrSpec> {
        Imr24W::new(self, 24)
    }
}
