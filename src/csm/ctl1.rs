...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en1(&mut self) -> En1W<Ctl1Spec> {
        En1W::new(self, 0)
    }
    #[doc = "Bit 1 - idel state polority"]
    #[inline(always)]
    #[must_use]
    pub fn idlep1(&mut self) -> Idlep1W<Ctl1Spec> {
        Idlep1W::new(self, 1)
    }
    #[doc = "Bit 2 - input signal select"]
    #[inline(always)]
    #[must_use]
    pub fn insel1(&mut self) -> Insel1W<Ctl1Spec> {
        Insel1W::new(self, 2)
    }
    #[doc = "Bit 3 - DMA enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn dmaen1(&mut self) -> Dmaen1W<Ctl1Spec> {
        Dmaen1W::new(self, 3)
    }
    #[doc = "Bit 4 - TXandRX data select control"]
    #[inline(always)]
    #[must_use]
    pub fn txsel1(&mut self) -> Txsel1W<Ctl1Spec> {
        Txsel1W::new(self, 4)
    }
}
