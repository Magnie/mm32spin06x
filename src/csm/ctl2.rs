...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en2(&mut self) -> En2W<Ctl2Spec> {
        En2W::new(self, 0)
    }
    #[doc = "Bit 1 - idel state polority"]
    #[inline(always)]
    #[must_use]
    pub fn idlep2(&mut self) -> Idlep2W<Ctl2Spec> {
        Idlep2W::new(self, 1)
    }
    #[doc = "Bit 2 - input signal select"]
    #[inline(always)]
    #[must_use]
    pub fn insel2(&mut self) -> Insel2W<Ctl2Spec> {
        Insel2W::new(self, 2)
    }
    #[doc = "Bit 3 - DMA enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn dmaen2(&mut self) -> Dmaen2W<Ctl2Spec> {
        Dmaen2W::new(self, 3)
    }
    #[doc = "Bit 4 - TXandRX data select control"]
    #[inline(always)]
    #[must_use]
    pub fn txsel2(&mut self) -> Txsel2W<Ctl2Spec> {
        Txsel2W::new(self, 4)
    }
}
