...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn startsel(&mut self) -> StartselW<CfgSpec> {
        StartselW::new(self, 0)
    }
    #[doc = "Bit 1 - stop select"]
    #[inline(always)]
    #[must_use]
    pub fn stopsel(&mut self) -> StopselW<CfgSpec> {
        StopselW::new(self, 1)
    }
    #[doc = "Bit 2 - master or slave select"]
    #[inline(always)]
    #[must_use]
    pub fn msel(&mut self) -> MselW<CfgSpec> {
        MselW::new(self, 2)
    }
    #[doc = "Bit 3 - Vtx enable"]
    #[inline(always)]
    #[must_use]
    pub fn vtxen(&mut self) -> VtxenW<CfgSpec> {
        VtxenW::new(self, 3)
    }
    #[doc = "Bit 4 - Vtx select"]
    #[inline(always)]
    #[must_use]
    pub fn vtxsel(&mut self) -> VtxselW<CfgSpec> {
        VtxselW::new(self, 4)
    }
    #[doc = "Bits 16:31 - max tx and rx bit"]
    #[inline(always)]
    #[must_use]
    pub fn maxbit(&mut self) -> MaxbitW<CfgSpec> {
        MaxbitW::new(self, 16)
    }
}
